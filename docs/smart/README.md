...
### [features.md](features.md) - Smart機能ガイド（739行）
Smart機能の包括的ガイド：異常検知、ファイル重要度分析、除外パターン推奨、自動設定

**対象**: すべてのユーザー、特にSmart機能を活用したい方
...
### [manual-test.md](manual-test.md) - Smart機能手動テスト手順（595行）
実機でのSmart機能テスト手順書
...
- [../../README.md](../../README.md) - プロジェクトメインREADME（Smart機能セクションあり）
...
- **2025-11**: Smart機能ドキュメント整理（docs/ai/に統合）
